        ...
        .AddScan2DHandle("/pavo_scan_bottom",
                         [&](Scan2d::Ptr scan) {
                             ...
                             if (fLS::FLAGS_method == "point2point") {
                                 ...
                                 icp.DegradationTesting(SE2(), last_scan, means_1, cov_1);
                                 icp.DegradationTesting(pose, current_scan, means_2, cov_2);
                                 LOG(INFO) << "前后帧均值之差: " << means_1 - means_2
                                            << ", 前后帧均方差之差: " << cov_1 - cov_2;
